...
def serialize(notification: dict) -> dict:
    ...
    return {
        ...
        'title_en': notification.get('title_en', notification.get('title', '')),
        'message_en': notification.get('message_en', notification.get('message', '')),
        'title_ar': notification.get('title_ar', notification.get('title', '')),
        'message_ar': notification.get('message_ar', notification.get('message', '')),
