  ...
  Widget _currentPlan(LanguageProvider lang) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(lang.t('subscription.current'), style: const TextStyle(color: AppColors.textSecondary, fontSize: 16)),
        const SizedBox(height: 8),
        Text(lang.t('subscription.free'), style: const TextStyle(color: AppColors.primaryDark, fontSize: 24, fontWeight: FontWeight.bold)),
        const SizedBox(height: 12),
        Text(lang.isRTL ? '5 فحوصات يومياً' : '5 scans per day',
  ...
  Widget _upgradeCard(BuildContext context, LanguageProvider lang) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(lang.t('subscription.upgrade'),
              style: const TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w600)),
          const SizedBox(height: 8),
          Text(lang.isRTL ? 'احصل على فحوصات غير محدودة وميزات متقدمة' : 'Get unlimited scans and advanced features',
