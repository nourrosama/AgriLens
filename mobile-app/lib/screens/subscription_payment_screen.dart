        ...
        child: Column(children: [
          Container(
            ...
            child: Row(children: [
              ...
              Text(lang.t('subscription.payment'),
            ...
            child: SingleChildScrollView(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Container(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text(lang.t('subscription.pro'), style: const TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w600)),
                ...
                _inputField(lang.t('subscription.cardNumber'), '0000 0000 0000 0000'),
                const SizedBox(height: 16),
                Row(children: [
                  Expanded(child: _inputField(lang.t('subscription.expiry'), 'MM/YY')),
                  const SizedBox(width: 16),
                  Expanded(child: _inputField(lang.t('subscription.cvv'), '***')),
                ]),
                const SizedBox(height: 32),
                SizedBox(
                  width: double.infinity,
                  child: ElevatedButton(
                    onPressed: () => context.push('/subscription-confirmation'),
                    style: ElevatedButton.styleFrom(
                      backgroundColor: AppColors.primary, foregroundColor: Colors.white,
                      padding: const EdgeInsets.symmetric(vertical: 20),
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
                    ),
                    child: Text(lang.t('subscription.pay'), style: const TextStyle(fontSize: 20)),
                  ),
                ),
              ]),
            ),
